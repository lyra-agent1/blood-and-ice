...
This folder keeps the project from drifting as the manuscript grows.
...
Any manuscript expansion must update continuity in the same PR. Lore that only exists in a generated scene is not canon until it is added here or to the relevant bible file.
